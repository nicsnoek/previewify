...
module Previewify
  module ActiveRecord
    ...
    def previewify(options = {})
      ...
      create_published_versions_class(previewify_config)

      def published_version_class
        const_get previewify_config.published_version_class_name
      end

      remove_methods_that_are_for_published_class_only(previewify_config)

    end

    private

    def remove_methods_that_are_for_published_class_only(previewify_config)
    ...
    def create_published_versions_class(previewify_config)
